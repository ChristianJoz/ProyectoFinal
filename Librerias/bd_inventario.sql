...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-07-2020 a las 23:35:43
...
(7, 'Cocacola', 'regrescante y fria', '9.99', '0.50', 'ltr', NULL, NULL, '2020-07-02 08:00:08');
...
(0, 'josue', 'morales', 'josue@gmail.com', 'josue', 'josue', 0, 0, 'animal', 'pinguino', '2020-06-30 00:30:29');
...
--
ALTER TABLE `tb_categoria`
  MODIFY `id_categoria` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `tb_producto`
--
ALTER TABLE `tb_producto`
  MODIFY `id_producto` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
